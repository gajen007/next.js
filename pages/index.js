      ...
      <div className=" d-flex justify-content-center mt-5">
        <form id="login" onSubmit={loginFunction}>
          <div className="card border-dark ">
            ...
            <div className="card-body"><input type="email" className="form-control-lg form-control rounded-3" required placeholder="Email" value={email} onChange={(e) => setEmail(e.target.value)}/>
              &nbsp;
              ...
              &nbsp;
              <div className="row "><div className="col-12"><Link href="/signup"><button type="reset" className="btn btn-outline-primary btn-lg form-control">Signup</button></Link></div></div>
            </div>
          </div>
        </form>
      </div>
